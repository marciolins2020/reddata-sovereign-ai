...
const timelineData = {
  ...
  llms: [{
    year: "2019",
    title: "GPT-2 (OpenAI)",
    detailHtml: "<p>Popularizou modelos grandes para pesquisa.</p>"
  }, {
    year: "2021",
    title: "GPT-Neo & GPT-J (EleutherAI)",
    detailHtml: "<p>Open source compatíveis com GPT-3; base para customização local.</p>"
  }, {
    year: "2023",
    title: "LLaMA (Meta)",
    detailHtml: "<p>Catalisou o ecossistema open source e os modos locais.</p>"
  }, {
    year: "2023",
    title: "Mistral 7B & Mixtral 8×7B",
    detailHtml: "<p>Modelos leves e eficientes (Apache 2.0), ideais para execução offline e MoE.</p>"
  }, {
    year: "2024",
    title: "LLaMA 3",
    detailHtml: "<p>Melhorias relevantes em entendimento e instrução.</p>"
  }, {
    year: "2025",
    title: "Apoio NVIDIA ao LLaMA",
    detailHtml: "<p>Refinamento e otimizações para execução local e enterprise.</p>"
  }]
};
...
const TimelineNode = ({
  ...
  return <div ref={nodeRef} className={`transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
      <button className={`h-4 w-4 rounded-full shadow-lg hover:scale-110 transition-transform focus:outline-none focus:ring-4 ring-2 ring-background relative z-10`} style={{
      backgroundColor: color
    }} title={`${item.year} – ${item.title}`} aria-label={`${item.year} – ${item.title}`} />
    </div>;
};
const Timeline = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className="min-w-[1200px] py-4">
              ...
              <section aria-label="Linha do tempo RedData" className="relative mb-8">
                ...
                <div className="relative grid grid-cols-12 gap-4">
                  ...
                  return <div key={idx} className="flex flex-col items-center text-center" style={{
          ...
          <section className="mt-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                {timelineData.reddata.map((item, idx) => <article key={idx} className="border border-border rounded-xl p-5 shadow-sm bg-card">
      ...
      <Dialog open={!!selectedItem} onOpenChange={() => setSelectedItem(null)}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="prose prose-sm max-w-none leading-relaxed mt-4 text-foreground" dangerouslySetInnerHTML={{
