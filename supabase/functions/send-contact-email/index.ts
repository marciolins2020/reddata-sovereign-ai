...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const confirmationEmail = await sendEmail(
      [formData.email],
      isEnglish ? "Thank you for your interest in RedData!" : "Obrigado pelo interesse no RedData!",
      isEnglish ? `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #0066cc;">Thank you for your interest in RedData!</h2>
          
          <p>Hello ${sanitizedData.nome},</p>
          
          <p>We received your inquiry about <strong>${sanitizedData.interesse}</strong> and our technical team will contact you within the next 24 hours to schedule a personalized demonstration.</p>
          
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #0066cc;">What happens now?</h3>
            <ul>
              <li>Our team will analyze your specific needs</li>
              <li>We will contact you within 24 hours</li>
              <li>We will schedule a personalized RedData demonstration</li>
              <li>We will present how RedData can transform your data into strategy</li>
            </ul>
          </div>
          
          <p>RedData is the only 100% Brazilian Business Intelligence solution with Generative AI that works completely offline, ensuring total digital sovereignty for your organization.</p>
          
          <p>Best regards,<br>
          <strong>RedMaxx Team</strong></p>
          
          <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">
          <p style="font-size: 12px; color: #666;">
            This email was sent automatically. If you did not request information about RedData, please ignore this message.
          </p>
        </div>
      ` : `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
