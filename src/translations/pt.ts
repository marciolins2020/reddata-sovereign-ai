export default {
  ...
  platformCapabilities: {
    ...
    visualizeDesc:
      "Dashboards interativos em tempo real, relatórios personalizados e integração com Power BI entre outras soluções de mercado. ",
  ...
  auth: {
    ...
    noAccount: "Não tem conta? Crie uma agora",
  ...
  dashboard: {
    ...
    trialExpiredMessage: "Seu período de teste de 30 dias expirou. Entre em contato para continuar usando.",
    storageUsed: "usado",
    logout: "Sair",
    uploadTab: "Upload de Arquivo",
    filesTab: "Meus Arquivos",
    dashboardsTab: "Meus Dashboards",
