export default {
  ...
  howItWorks: {
    ...
    pillar1Title: "Integração de Dados",
    pillar1Desc: "Conecte todas as suas fontes de dados em tempo real",
    pillar2Title: "Processamento Inteligente",
    pillar2Desc: "Análise avançada com IA e machine learning",
    pillar3Title: "Visualização Intuitiva",
    pillar3Desc: "Dashboards personalizados para tomada de decisão",
    pillar4Title: "Segurança Garantida",
    pillar4Desc: "Certificação ISO 27001 e conformidade total com LGPD"
  },
  appliance: {
